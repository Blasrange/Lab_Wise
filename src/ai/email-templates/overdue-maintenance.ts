...
interface OverdueMaintenanceEmailProps {
  equipment: Equipment;
  task: EquipmentHistory;
  recipientName: string;
}

export const generateOverdueMaintenanceEmail = ({
  equipment,
  task,
  recipientName,
}: OverdueMaintenanceEmailProps): string => {
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .card-equipment { background-color: #f8f9fa; border: 1px solid #dee2e6; }
    ...
    equipment.internalCode
            ...
            <div class="detail-row"><span class="detail-label">${
              t.brand
            }:</span> <span class="detail-value">${equipment.brand}</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.model
            }:</span> <span class="detail-value">${equipment.model}</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.serialNumber
            }:</span> <span class="detail-value">${
    ...
    equipment.systemNumber
  }</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.lastExtCalibration
            }:</span> <span class="detail-value">${
    equipment.lastExternalCalibration
  }</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.nextExtCalibration
            }:</span> <span class="detail-value">${
    equipment.nextExternalCalibration
          ...
          <div class="card card-maintenance">
            ...
            <div class="detail-row"><span class="detail-label">${
              t.type
            }:</span> <span class="detail-value">${task.action}</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.status
            }:</span> <span class="detail-value">${task.status}</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.priority
            }:</span> <span class="detail-value">${
    task.priority || "N/A"
            ...
            <div class="detail-row"><span class="detail-label">${
              t.scheduledDate
            }:</span> <span class="detail-value">${task.date}</span></div>
            <div class="detail-row"><span class="detail-label">${
              t.responsible
            }:</span> <span class="detail-value">${
    task.responsible
